...
public class GenericSpecificationsBuilder<T> {
    ...
    public final GenericSpecificationsBuilder<T> with(final String key, final SearchOperations searchOperation, final List<Object> arguments) {
        return with(key, searchOperation, false, arguments);
    }

    public final GenericSpecificationsBuilder<T> with(final String key, final SearchOperations searchOperation, final boolean isOrOperation, final List<Object> arguments) {
